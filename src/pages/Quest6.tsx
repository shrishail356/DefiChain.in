    ...
    <>
      ...
      <div className="flex rounded-lg p-6 m-10 shadow-md text-white font-quicksand">
        <div className="w-4/5 pr-5 border-r border-gray-500">
          <h2 className="text-3xl font-bold pt-5 mb-4">Quest 6 : Explore Wallets</h2>
          <div className="bg-gray-800 task-item mb-4 border-white-800 p-5 rounded-lg flex items-center text-lg font-semibold transition duration-300 ease-in-out transform hover:scale-105 hover:border-white-500 hover:shadow-md hover:border">
            ...
            <p className="ml-3">Explore DeFiChain Wallets....</p>
            <div className="ml-auto">
              <a href="https://defichain.com/explore/wallets" target="_blank" rel="noopener noreferrer">
                <button
          ...
          <div className="bg-gray-800 task-item mb-4 border-white-800 p-5 rounded-lg flex items-center text-lg font-semibold transition duration-300 ease-in-out transform hover:scale-105 hover:border-white-500 hover:shadow-md hover:border">
            <img src="https://defichain.com/assets/img/explore/explore-wallet-jellywallet.png" alt="Icon" className="w-auto h-6" />
            <span className="ml-3">Download Jellywallet for Chrome</span>
            <div className="ml-auto">
              <a href="https://chromewebstore.google.com/detail/jellywallet/eegcfalgkkhehkhbjbggbhhlcnckadih" target="_blank" rel="noopener noreferrer">
                <button
                  className={`task-button ml-auto bg-blue-500 text-white font-semibold py-2 px-4 rounded 
                    ${
                      joinClicked
                ...
                >
                  {joinClicked ? (joinVerified ? 'Verified' : 'Verifying...') : 'Download'}
                </button>
              </a>
            </div>
          </div>
          ...
          <div className="bg-gray-800 task-item mb-4 border-white-800 p-5 rounded-lg flex items-center text-lg font-semibold transition duration-300 ease-in-out transform hover:scale-105 hover:border-white-500 hover:shadow-md hover:border">
            ...
            <span className="ml-3">View DeFiChain Electrum on Github</span>
            <div className="ml-auto">
              <a href="https://github.com/BirthdayResearch/defichain-electrum/releases/tag/ivan/update-download-link" target="_blank" rel="noopener noreferrer">
                <button
                  className={`task-button ml-auto bg-blue-500 text-white font-semibold py-2 px-4 rounded 
                    ${
                      telegramClicked
                ...
                >
                  {telegramClicked ? (telegramVerified ? 'Verified' : 'Verifying...') : 'View'}
                </button>
              </a>
            </div>
          </div>
          ...
          <div className="bg-gray-800 task-item mb-4 border-white-800 p-5 rounded-lg flex items-center text-lg font-semibold transition duration-300 ease-in-out transform hover:scale-105 hover:border-white-500 hover:shadow-md hover:border">
            <img src="https://defichain.com/assets/img/explore/explore-wallet-cli.png" alt="Icon" className="w-auto h-7" />
            <p className="ml-3">Transact and interact with DeFiChain through a CLI</p>
            <div className="ml-auto">
              <a href="https://github.com/defiCh/ain/releases/tag/v4.0.5" target="_blank" rel="noopener noreferrer">
                <button
                  className={`task-button ml-auto bg-blue-500 text-white font-semibold py-2 px-4 rounded 
                    ${
                      repostClicked
